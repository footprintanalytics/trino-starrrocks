        ...
        extends BaseJdbcConnectionCreationTest
{
    ...
    public Object[][] testCases()
    {
        return new Object[][] {
                ...
                {"UPDATE copy_of_nation SET name = 'POLAND' WHERE nationkey = 1", 14, Optional.empty()},
                {"MERGE INTO copy_of_nation n USING region r ON r.regionkey= n.regionkey WHEN MATCHED THEN DELETE", 15, Optional.empty()},

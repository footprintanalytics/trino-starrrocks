 ...
 */
package io.trino.tests.product.starrocks;
...
import static io.trino.tests.product.TestGroups.STAR_ROCKS;
import static io.trino.tests.product.utils.QueryExecutors.onTrino;

public class TestStarRocks
        extends ProductTest
{
    @Test(groups = {STAR_ROCKS, PROFILE_SPECIFIC_TESTS})
